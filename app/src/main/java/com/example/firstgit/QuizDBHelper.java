    ...
    public List<Question> getAllQuestions() {
        ...
        if (c.moveToFirst()) {
            do {
                ...
                question.setOptions1(c.getString(c.getColumnIndex(QuestionTable.COLUMN_OPTION1)));
                question.setOptions2(c.getString(c.getColumnIndex(QuestionTable.COLUMN_OPTION2)));
                question.setOptions3(c.getString(c.getColumnIndex(QuestionTable.COLUMN_OPTION3)));
                question.setOptions4(c.getString(c.getColumnIndex(QuestionTable.COLUMN_OPTION4)));
